...
import net.kokwind.mall.common.Constant.Cart;
import net.kokwind.mall.common.Constant.OrderStatusEnum;
...
import net.kokwind.mall.filter.UserFilter;
import net.kokwind.mall.model.dao.CartMapper;
import net.kokwind.mall.model.dao.OrderItemMapper;
import net.kokwind.mall.model.dao.OrderMapper;
...
import net.kokwind.mall.model.request.CreateOrderReq;
import net.kokwind.mall.model.vo.CartVO;
import net.kokwind.mall.model.vo.OrderItemVO;
import net.kokwind.mall.model.vo.OrderVO;
import net.kokwind.mall.service.CartService;
import net.kokwind.mall.service.UserService;
import net.kokwind.mall.util.OrderCodeFactory;
import net.kokwind.mall.util.QRCodeGenerator;
...
public class OrderService{
    ...
    public String create(CreateOrderReq createOrderReq) {
        ...
        if (CollectionUtils.isEmpty(cartVOList)) {
            throw new DdMallException(DdMallExceptionEnum.CART_EMPTY);
        }
        //判断商品是否存在、上下架状态、库存
    ...
    public OrderVO detail(String orderNo) {
        ...
        //订单不存在，则报错
        if (order == null) {
            throw new DdMallException(DdMallExceptionEnum.NO_ORDER);
        }
        //订单存在，需要判断所属
        Integer userId = UserFilter.currentUser.getId();
        if (!order.getUserId().equals(userId)) {
            throw new DdMallException(DdMallExceptionEnum.NOT_YOUR_ORDER);
        }
    ...
    public void cancel(String orderNo) {
        ...
        if (order.getOrderStatus().equals(OrderStatusEnum.NOT_PAID.getCode())) {
            ...
            throw new DdMallException(DdMallExceptionEnum.WRONG_ORDER_STATUS);
        }
    }
