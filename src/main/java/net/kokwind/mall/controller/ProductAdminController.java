...
import net.kokwind.mall.model.request.AddProductReq;
import net.kokwind.mall.model.request.UpdateProductReq;
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest,
        ...
        if (!fileDirectory.exists()) {
            if (!fileDirectory.mkdir()) {
                throw new DdMallException(DdMallExceptionEnum.MKDIR_FAILED);
            }
        }
        try {
        ...
        try {
            ...
            return ApiRestResponse.error(DdMallExceptionEnum.UPLOAD_FAILED);
        }
    }
